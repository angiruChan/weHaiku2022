...
urlpatterns = [
    ...
    path("filter_haiku_entry_status/<str:es_id>", views.filter_haiku_entry_status, name="filter_haiku_entry_status"),
    path("filter_haiku_entry_theme/<str:value>", views.filter_haiku_entry_theme, name="filter_haiku_entry_theme"),
    ...
    path("filter_haiku/<str:c_id>", views.filter_haiku, name="filter_haiku"),
    path("filter_haiku_status/<str:value>/", views.filter_haiku_status, name="filter_haiku_status"),
